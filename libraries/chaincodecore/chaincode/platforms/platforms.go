...
import (
	...
	"gocoin/libraries/chaincodecore/common/metadata"
	golang "gocoin/libraries/chaincodecore/chaincode/platforms/golang"
...
var logger = flogging.New("chaincode-platform")
...
func GenerateDockerBuild(cds *pb.ChaincodeDeploymentSpec) (io.Reader, error) {
    ...
    */
	...
	// ----------------------------------------------------------------------------------------------------
	dockerFile, err := generateDockerfile(platform, cds, false)
	if err != nil {
