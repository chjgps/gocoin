...
func TestValidateCDS(t *testing.T) {
	...
	specs = append(specs, spec{CCName: "NoCode", Path: "path/to/somewhere", File: "/src/path/to/somewhere/main01.go", Mode: 0100400, SuccessExpected: true})
...
func Test_findSource(t *testing.T) {
	...
	if _, ok := source["src/github.com/hyperledger/fabric/peer/main01.go"]; !ok {
...
func TestGenerateDockerBuild(t *testing.T) {
	...
	specs = append(specs, spec{CCName: "AutoVendor", Path: "github.com/hyperledger/fabric/test/chaincodes/AutoVendor/chaincode", File: "/src/github.com/hyperledger/fabric/test/chaincodes/AutoVendor/chaincode/main01.go", Mode: 0100400, SuccessExpected: true, RealGen: true})
